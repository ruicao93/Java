...
<%@ page import="group2.model.*" %>
	...
	<div align="center">
		...
		<form name="form1" method="post" action="modfyProductDo.do" target="_self" enctype="multipart/form-data" >
		<table width="80%" border="0" cellpadding="0" cellspacing="1">
			<tr>
			<td width="50%" height="20" align="right">商品名称：</td>
			<td width="50%" height="20" align="left">&nbsp;<input type="text" name="pname" value="${pf.pname }" size="30"></td>
			</tr>
			<tr>
			...
			<td width="50%" height="20" align="left">&nbsp;<input type="text" name="company" value="${pf.company }" size="30"></td>
			</tr>
			<tr>
			<td width="50%" height="20" align="right">产地：</td>
			<td width="50%" height="20" align="left">&nbsp;<input type="text" name="address" value="${pf.address }" size="30"></td>
			</tr>
			<tr>
			<td width="50%" height="20" align="right">价格：</td>
			<td width="50%" height="20" align="left">&nbsp;<input type="text" name="price" value="${pf.price }" size="10">（RMB）</td>
			</tr>
			
			<tr>
			<td width="50%" height="20" align="right">商品简介：</td>
			<td width="50%" height="20" align="left">&nbsp;<textarea name="introduce" rows="6" cols="30">${pf.introduce}</textarea></td>
			</tr>
			<tr>
